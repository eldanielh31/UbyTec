...
@Component({
  selector: 'app-register-affil',
  templateUrl: './register-affil.component.html',
  styleUrls: ['./register-affil.component.css']
})
export class RegisterAffilComponent implements OnInit {
